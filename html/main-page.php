...
?>
    ...
    <div class="wrapper-section">
        <div class="solutions-page">
            <div class="container">
                ...
                <div class="buttons">
                    <a href="#" class="btn btn-large font-paragraph-base font-bold btn-outline"><span class="button-text">More Solutions</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper-section">
        <div class="how-works wow fadeIn" data-wow-delay="0.3s" data-wow-duration="1s">
            ...
            <div class="block-3d" style="background-image: url('<?=SITE_TEMPLATE_PATH?>/images/bg-3d.png')">
